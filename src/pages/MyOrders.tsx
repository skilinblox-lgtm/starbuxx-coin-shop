...
const statusLabels: Record<string, { label: string; color: string }> = {
  aguardando_pagamento: { label: "Aguardando", color: "bg-yellow-500/10 text-yellow-600" },
  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      <div className="container px-4 py-6 sm:py-10">
        ...
        {loading ? (
          <p className="mt-6 text-sm text-muted-foreground sm:mt-8">Carregando...</p>
        ) : orders.length === 0 ? (
          ...
          <div className="mt-6 space-y-3 sm:mt-8 sm:space-y-4">
            {orders.map((o) => {
              ...
              return (
                <div key={o.id} className="rounded-2xl border border-border bg-background p-4 shadow-[var(--shadow-card)] sm:p-6">
