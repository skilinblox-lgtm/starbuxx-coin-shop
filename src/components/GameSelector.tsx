...
const GameSelector = () => {
  ...
  // Group by game
  const gameGroups = products.reduce((acc: Record<string, any[]>, p) => {
            ...
            {products.map((product, i) => (
              ...
              >
                <Link
                  ...
                  className="group block rounded-2xl border border-border bg-background p-4 transition-all hover:border-primary/40 hover:shadow-[var(--shadow-gold)] sm:p-5"
                >
